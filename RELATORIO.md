...
*   **Limites Positivos Iniciais:** Foi atestado o fechamento a 1 de todos os naturais não-nulos até $200.000$ sob detecção linear ascendente; nenhum desvio cíclico documentado. (Isto está muito abaixo do recorde publicado $2^{68}$, Barina 2021; é incluído apenas como hipótese autossuficiente e reexecutável para a exclusão diofantina abaixo.)
...
*   Sob a hipótese verificada em R1 ($N = 200.000$), o certificado diofantino implica que qualquer ciclo positivo não trivial teria mais de $428$ passos ímpares e mais de $676$ passos totais. Sob a hipótese publicada por Barina ($N = 2^{68}$), as respectivas cotas passam para mais de $8.517.411.709$ passos ímpares e mais de $13.457.510.500$ passos totais (e, portanto, elementos). Essas são consequências condicionais das hipóteses de verificação, não provas adicionais de convergência.
