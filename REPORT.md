...
* **Finite-Level Rank Collapse ($3^k$):** At $k=3$ (the ring $\mathbb{Z}/27\mathbb{Z}$), exact rational verification confirms $P_3^3 = \mathbf{1}\pi_3$. Separately, the stationary measure modulo $3$ is $(1/3,2/3)$ and the uniform measure is not stationary. These are facts about the tested finite kernel.
