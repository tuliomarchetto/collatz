...
def test_exclusion_bound_at_published_verification_limit():
    bound = cycle_exclusion_bound(2**71)
    assert bound["min_odd_steps"] == 65_470_613_320
    assert bound["min_length_T_steps"] == 103_443_569_045
    assert bound["min_elements"] == 103_443_569_045
